 ...
 *
 * 说明
 * 该模块以检查是否有消息传送给变量text开始
 * 如果有则将信息插入到messages表中。同时，变量pm的值也被保存。它表明信息是私有还是共有的：0表示共有信息，1表示私有信息
 * 接下来显示一个用于用户简介和输入消息的表单，附加一组单选按钮来确定发送共有还是私有消息
 *
 * 该模块简单的来说就是一个留言板的实现
 */
...
echo "<br><a class='button' href='messages.php?view=$view'>Refresh message</a> ";
